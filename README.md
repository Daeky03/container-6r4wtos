...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-6r4wtos.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-6r4wtos.containers.anotherwebservice.com/
...
```
git clone git@github.com:Daeky03/container-6r4wtos.git
cd container-6r4wtos
```
...
```
docker attach container-6r4wtos
```
